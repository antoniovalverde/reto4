...
const Movies = props =>{
    ...
    const g = axios.get(`https://api.themoviedb.org/3/genre/movie/list?api_key=f6c510b3b52b2f6efd5ed11ca30c9c4d&language=es-ES`)
                .then(resp => setGeneros(resp.data.genres))
                .catch(console.error)
